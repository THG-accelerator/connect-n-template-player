...
public class LCAGameState {
    private Map<Counter, Integer> maxInARowByCounter;
    private boolean win;
    private boolean draw;
    private Counter winner;

    public LCAGameState(Counter winner) {
        this.winner = winner;
        this.win = true;
    }

    public LCAGameState(Map<Counter, Integer> maxInARowByCounter, GameConfig config, boolean isFull) {
    ...
    public boolean equals(Object o) {
        ...
        LCAGameState gameState = (LCAGameState) o;
